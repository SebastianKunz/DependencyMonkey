...
using ReSharperPlugin.DependencyMonkey.QuikGraph.Collections;
using ReSharperPlugin.DependencyMonkey.QuikGraph.Delegates.Edges;
using ReSharperPlugin.DependencyMonkey.QuikGraph.Delegates.Vertices;
using ReSharperPlugin.DependencyMonkey.QuikGraph.Exceptions;
using ReSharperPlugin.DependencyMonkey.QuikGraph.Interfaces.Collections;
using ReSharperPlugin.DependencyMonkey.QuikGraph.Interfaces.Edges;
using ReSharperPlugin.DependencyMonkey.QuikGraph.Interfaces.Graphs;
using System;
...
namespace ReSharperPlugin.DependencyMonkey.QuikGraph.Structures.Graphs
{
    /// <summary>
